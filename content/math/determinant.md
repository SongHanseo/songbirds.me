...
$$
\text{det}(A)=\sum_{\sigma\in \text{Sym}(n)}\left( \text{sgn}(\sigma)\prod_{i=1}^na_{i,\sigma(i)} \right)
$$

여기서 $\text{Sym}$은 [대칭군](https://ko.wikipedia.org/wiki/%EB%8C%80%EC%B9%AD%EA%B5%B0_(%EA%B5%B0%EB%A1%A0))을, $\text{sgn}$은 순열의 부호함수를 뜻합니다. 
